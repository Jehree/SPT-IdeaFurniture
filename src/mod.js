...
class Mod {
    ...
    addSimpleItemToDb(itemTemplate) {
        const itemClone = mod_helper_1.FileUtils.jsonClone(this.Helper.dbItems[itemTemplate.itemType]);
        ...
        if (itemTemplate.itemType === "5c0a840b86f7742ffa4f2482") {
            ...
            if (itemTemplate.id === "678ff6a08def9feca215636e") {
                ...
                itemClone._props.Grids[0]._props.filters[0].Filter.push("5485a8684bdc2da71d8b4567", "543be5cb4bdc2deb348b4568", "5448bc234bdc2d3c308b4569");
            }
            ...
            if (itemTemplate.id === "678ff7ec91e978af07400932") {
                ...
                itemClone._props.Grids[0]._props.filters[0].Filter = [];
                itemClone._props.Grids[0]._props.filters[0].Filter.push("5448fe124bdc2da5018b4567", "5422acb9af1c889c16000029", "5485a8684bdc2da71d8b4567", "543be5cb4bdc2deb348b4568", "5448bc234bdc2d3c308b4569", "5448eb774bdc2d0a728b4567");
            }
    ...
    addSimpleItemToTraderAssort(itemTemplate) {
        const trader = this.Helper.dbTraders[traderJson._id];
        const barter = {
            count: itemTemplate.cost,
            _tpl: mod_helper_1.CurrencyId.RUB,
        };
        const item = {
